...
for split in ['train', 'valid', 'test']:
    raw_file_path = f"/home/Nema/orginial_unicrs/UniCRS/src/data/{dataset}/{split}_data_processed.jsonl"
    raw_file = open(raw_file_path, encoding='utf-8')
    raw_data = raw_file.readlines()
    # print(len(raw_data))

    gen_file_path = f"/home/Nema/orginial_unicrs/UniCRS/src/save/{dataset}/{gen_file_prefix}_{split}.jsonl"
    gen_file = open(gen_file_path, encoding='utf-8')
    gen_data = gen_file.readlines()

    new_file_path = f'/home/Nema/orginial_unicrs/UniCRS/src/{split}_data_processed.jsonl'
