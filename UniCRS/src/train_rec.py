...
if __name__ == '__main__':
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            # relationship_embeddings = recommenderPromptEnhancer.get_enhanced_rec_prompt(dialogue_text)
            relationship_embeddings = enhancer.get_enhanced_rec_prompt(step, dialogue_text)
            relationship_embeddings=relationship_embeddings if relationship_embeddings is not None else None
            
            if relationship_embeddings is not None:
                print(f"[DEBUG] Relationship Embeddings Shape: {relationship_embeddings.shape}")
            else:
                print("[ERROR] relationship_embeddings is None!")
            # --------------------------------------------------------------------
