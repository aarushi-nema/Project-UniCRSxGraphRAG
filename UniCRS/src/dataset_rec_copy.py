...
from UniCRS.src.utils import padded_tensor
            ...
            for line in tqdm(lines):
                ...
                for i, utt in enumerate(dialog['context']):
                    ...
                    if i % 2 == 0:
                        ...
                        context += 'System: '
                    context += utt
                    context += self.tokenizer.eos_token  # Appends <|endoftext|>
                ...
                # Decode text and remove <|endoftext|> (EOS token)
                decoded_text = self.tokenizer.decode(context_ids).replace("<|endoftext|>", "").strip()
                ...
                for item in dialog['rec']:
                    data = {
                        ...
                        'rec': item,
                        'dialogue': decoded_text  # Add cleaned text
                        # ADD THE KG OF THE DIAOGUE HERE TOO! 
                    }
...
class CRSRecDataCollator:
    ...
    def __call__(self, data_batch):
        ...
        for data in data_batch:
            ...
            dialogue_batch.append(data['dialogue'])  # Add dialogue to the batch
        ...
        input_batch['dialogue'] = dialogue_batch 
